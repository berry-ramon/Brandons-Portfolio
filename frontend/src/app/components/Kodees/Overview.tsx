...
export const Overview = () => {
  ...
  return (
    ...
    >
      <div>
        <h2 className="text-2xl md:text-3xl font-light mb-4">{data.title}</h2>
        <p className="text-base opacity-70 leading-relaxed">{data.context}</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="border-l-2 border-accent/20 pl-4">
          <p className="text-sm italic opacity-80">{data.focus}</p>
        </div>
      </div>
    </motion.section>
  );
